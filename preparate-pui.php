...
<html>
    <head>
        <title>Preparate Pui &amp; Porc MyWay Craiova</title>
        <meta name="description" content="La MyWay poti cumpara platouri cu cele mai delicioase preparate culinare. Comanda acum!">
        <meta name="keywords" content="myway, craiova, preparate, pui, porc">
    ...
    <body>
        ...
        <section class="pizza">
            <div class="container">
                <div class="row">
                    <h3 class="title">Preparate de pui</h3>
                    <div style="margin-bottom: 40px;" class="separator"></div>
                    <div class="col-md-12">
                        <p>Cea mai buna leguma este carnea, zice o vorba din popor. La pizza MyWay alegem cea mai buna carne pentru ca papilele tale sa fie rasfatate asa cum merita. Poti opta pentru snitel, piept de pui la gratar, ficatei, piept de pui cu susan, si multe altele.</p>
                    </div>
                    <div class="clear"></div>		
                    <?php
                    $query = "SELECT * FROM produse WHERE categorie='pui'";
...
?>
        ...
        <section class="pizza">
            <div class="container">
                <div class="row">
                    <h3 class="title">Preparate de porc</h3>
                    <div style="margin-bottom: 40px;" class="separator"></div>
                    <div class="col-md-12">
                        <p>Ti-e pofta de o tochitura moldoveneasca sau de o ceafa de porc la gratar?  Pentru zilele cand ti-e dor de o mancare ca la mama acasa, si nu numai, te asteptam sa comanzi preparatele noastre.</p>
                    </div>
                    <div class="clear"></div>


<?php
$query = "SELECT * FROM produse WHERE categorie='porc'";
     $result = mysqli_query($link, $query);
                        $i = 0;
                        while ($row = mysqli_fetch_assoc($result)) {
    $i++;
    ?>
                        <div class="col-md-6 product">
                            <div class="pad4">
                                <div class="col-sm-3">
                                    <img class="img-responsive" src="assets/images/produse/<?php echo $row['poza']; ?>"  alt="<?php echo $row['titlu']; ?>"/>
                                </div>
                                <div class="col-sm-8">
                                    <h5 class="title-product ">
                                        <span class="title"><?php echo $row['titlu']; ?> - <?php echo $row['gr']; ?>gr</span>
