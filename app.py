...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///pizzamyway.db'
...
CATEGORY_MAPPING = {
    ...
    'catering-myway-craiova': {'db_cat': 'platou-1-2', 'title': 'Catering'}, # Mapping catering to platou for now as no 'catering' cat exists, or show all platours
    ...
    'preparate-la-cuptor': {'db_cat': 'porc', 'title': 'Preparate Porc'}, # 'cuptor' not found, 'porc' found.
