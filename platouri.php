...
<html>
    ...
    <body>
        ...
        <section class="pizza">
            <div class="container">
                <div class="row">
                    <h3 class="title">Platouri</h3>
                    <div style="margin-bottom: 40px;" class="separator"></div>
                    <div class="col-md-12">
                        <p>Vin prietenii in vizita dar tu nu ai timp sa gatesti? Noi salvam situatia!  Si daca nu stii ce vrei, ai la dispozitie platouri cu pui, platouri cu pui shanghai, platouri cu prosciutto si multe altele din care poti alege. Tu alegi, iar noi iti aducem platoul dorit. </p>
                        <p style='color: red'>Optional, pentru o livrare in siguranta puteti alege transportul si livrarea pe platouri cu capac din plastic. Cost suplimentar: 10 lei/platou.</p>
                    </div>
                    <div class="clear"></div>				
                </div>
            </div>
		 ...
		 <section class="pizza">
            <div class="container">
                <div class="row">
					...
					<h3 class="title">Platouri 3/4 persoane</h3>
                    <div style="margin-top: 20px;" class="separator"></div>
                    <div class="clear"></div>
                 
					<?php
						$query = "SELECT * FROM produse WHERE categorie='platou-3-4'";
